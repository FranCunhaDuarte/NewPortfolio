    ...
    <>
        <div className='flex flex-col items-center justify-center gap-28 my-20' >
          ...
          <div className='grid grid-cols-1 md:grid-cols-2'>
            ...
            {/* About Me Text */}
            <div className='w-[85%] sm:w-[90%] mx-auto text-desc-cont'>
              <div className='overflow-hidden px-7 relative w-fit mx-auto'><div ref={titleLine} className='line-gradient-to-right absolute bottom-0 left-0'></div><span ref={title} className='title-glow font-black inline-block text-nowrap text-[8vw] mt-10 md:mt-0 md:text-[4.5vw] xl:text-[3vw] font-sfpro skew-x-[-15deg] bg-clip-text text-transparent' style={ {backgroundImage: "var(--gradient-primarywhite)"} }>BEHIND THE CODE</span></div>
